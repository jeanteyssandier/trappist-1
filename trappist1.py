...
def run_sim(n, verbose=False):
    ...
    for i,time in enumerate(times):
        ...
        sim.integrate(time)                             # Do the integration step
        ps = sim.particles                              # Access particles
        orb = sim.calculate_orbits()                    # Compute orbital elements
        sim.simulationarchive_snapshot(run_name+'.bin') # Save simulation in binary file
...
if __name__ == '__main__':
    ...
    parser.add_argument('-s,', dest='seed', type=int, default=None,
                        help='Initial seed for random generator', required=False)
